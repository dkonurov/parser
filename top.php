...
$prevpage = $currpage-1;	
echo "<br>";
echo "<a style=\"margin-left:600px;text-decoration:none;\" href=\"/parser/top.php?page=$prevpage\"><</a>";
echo " "; echo $currpage; echo " ";
echo "<a style=\"text-decoration:none;\" href=\"/parser/top.php?page=$nextpage\">></a>";
...
$query = "SELECT * FROM `quotes` ORDER BY rating DESC LIMIT $c, 20 ";
